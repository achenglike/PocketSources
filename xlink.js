async function xlink_process(input){
    ...
    var mediaEntries = JSON.parse(bodyStr).data.threaded_conversation_with_injections_v2.instructions[0].entries.filter(v => v.content.entryType == 'TimelineTimelineItem' && v.entryId.startsWith('tweet-'));
